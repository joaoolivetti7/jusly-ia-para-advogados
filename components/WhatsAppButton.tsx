...
const WhatsAppButton: React.FC = () => {
  return (
    ...
    >
      <div className="absolute inset-0 rounded-full bg-[#25D366] animate-ping opacity-20 duration-2000"></div>
      <svg
        viewBox="0 0 24 24"
        fill="currentColor"
      ...
      <span className="absolute -top-1 -right-1 flex h-5 w-5 z-20">
        <span className="relative inline-flex rounded-full h-5 w-5 bg-red-600 text-[10px] font-bold text-white items-center justify-center border-2 border-black"></span>
      </span>
    </a>
  );
};
